...
#placeholder for is_an_ip_number? method that always returns true
...
def dot_separated_ip_address?(input_string)
  dot_separated_words = input_string.split(".")
  dot_separated_words.select { |word| is_an_ip_number?(word) }.size == 4
end

#test cases

puts dot_separated_ip_address?("4.5.5.5.1")
puts dot_separated_ip_address?("5.5.1")
puts dot_separated_ip_address?("4.5.5.5")