...
>> This checks that the remainder after dividing number / divisor is 0 - which indidates divisor is a factor of number

Bonus 2
What is the purpose of the second-to-last line (line 8) in the method (the factors before the method's end)?

> This ensures that we return the factors array from the method
