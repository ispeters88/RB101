...
## EXPLANATION ##
# > The last line of the method used assignment (=) rather than an equality check (==)

## Further Exploration ##
# If you take a close look at odd_count == 3 ? true : false, you see that the equality comparison 
# odd_count == 3 itself returns a Boolean. 
# Is the ternary operator on line 5 really necessary in order to return a Boolean from our method?

# > No - this can be simplified to 
def valid_series?(nums)
  return false if nums.sum != 47
